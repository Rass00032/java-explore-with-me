...
import static ru.practicum.entity.Event.State.PUBLISHED;
import static ru.practicum.entity.ParticipationRequest.Status.CONFIRMED;
import static ru.practicum.entity.ParticipationRequest.Status.REJECTED;
import static ru.practicum.model.request.UpdateEventAdminRequest.StateAction.PUBLISH_EVENT;
import static ru.practicum.model.request.UpdateEventAdminRequest.StateAction.REJECT_EVENT;
